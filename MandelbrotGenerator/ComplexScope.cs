...
namespace MandelbrotGenerator
{
    public sealed class ComplexScope : IEquatable<ComplexScope>, IFormattable
    {
        ...
        /// <inheritdoc />
        public bool Equals(ComplexScope other) => LowerLeft.Equals(other.LowerLeft) && UpperRight.Equals(other.UpperRight);
        /// <inheritdoc />
        ...
        public static bool operator ==(ComplexScope left, ComplexScope right) => left.Equals(right);
        public static bool operator !=(ComplexScope left, ComplexScope right) => !left.Equals(right);
